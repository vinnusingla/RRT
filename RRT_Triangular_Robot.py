    ...
    while True:
        if currentState == 'init':
            ...
            for i in range(0,length):
                ...
                milliseconds = fpsClock.tick(FPS) # do not go faster than this framerate
                ...
                x1 = nodes1[length-1-i].point[0]
                y1 = nodes1[length-1-i].point[1]
                x2 = x1
                y2 = y1 + 12
                x3 = x1 + 8
                y3 = y1 + 6
