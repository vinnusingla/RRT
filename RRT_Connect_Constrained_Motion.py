    ...
    while True:
        if currentState == 'init':
            ...
            while currNode1.parent != None:
                pygame.draw.line(screen,red,currNode1.point,currNode1.parent.point)
            ...
            count = count+1
            pygame.display.set_caption('Performing RRT_CONNECT WITH CONSTRAINED MOTION')
            if count < NUMNODES:
                foundNext = False
                ...
                while foundNext1 == False:
                    ...
                    for p in nodes1:
                        if dist(p.point,rand1) <= dist(parentNode1.point,rand1):
                ...
                #pygame.draw.line(screen,blue,parentNode1.point,newnode2)
                reached = False
                collide = False
                while (reached == False and collide == False):
                    ...
                    if collides(newnode4) == False:
                        ...
                        newnode3=newnode5
                        pygame.draw.line(screen,blue,newnode3.point,newnode4)
                        if newnode4 == rand1:
                            reached = True
                        else:
                        	reached = False
